...
! function(e) {
    ...
    a = [n(2), n(4)], void 0 === (r = "function" == typeof(i = function(e, t) {
        var n = {
        ...
        function s(e, t, i) {
            ...
            if ("string" == typeof c) {
                for (; o = a(i).exec(t);) {
                    ...
                    n.hasOwnProperty(o[0]) && (l = n[o[0]][0], r = n[o[0]][2], s = n[o[0]][1], p(u, f)), c = c.slice(f.length)
                }
                return u
            }
        }
    ...
    var i, a, r;
    "function" == typeof Symbol && Symbol.iterator;
    a = [n(3)], void 0 === (r = "function" == typeof(i = function(e) {
        return e
    }) ? i.apply(t, a) : i) || (e.exports = r)
}, function(e, t) {
    e.exports = jQuery
        ...
        function m(a, c, p) {
            ...
            function w(e, t, n, a, r) {
                ...
                var s, l, u, c = [],
                    ...
                    m = D();
                do {
                    if (!0 === e && E().validPositions[f]) u = r && !0 === E().validPositions[f].match.optionality && E().validPositions[f + 1] === i && (!0 === E().validPositions[f].generatedInput || E().validPositions[f].input == p.skipOptionalPartCharacter && f > 0) ? j(f, R(f, s, f - 1)) : E().validPositions[f], l = u.match, s = u.locator.slice(), c.push(!0 === n ? u.input : !1 === n ? l.nativeDef : $(f, l));
                    else {
                        u = F(f, s, f - 1), l = u.match, s = u.locator.slice();
                        var d = !0 !== a && (!1 !== p.jitMasking ? p.jitMasking : l.jit);
                        !1 === d || d === i || f < m || "number" == typeof d && isFinite(d) && d > f ? c.push(!1 === n ? l.nativeDef : $(f, l)) : l.jit && l.optionalQuantifier
                    }
            ...
            function j(e, t) {
                for (var n, a, r, o = T(e = e > 0 ? e - 1 : 0), s = _(o), l = 0; l < t.length; l++) {
                    var u = t[l];
                    n = _(u, s.length);
                    var c = Math.abs(n - s);
                    (a === i || "" !== n && c < a || r && r.match.optionality && "master" === r.match.newBlockMarker && (!u.match.optionality || !u.match.newBlockMarker) || r && r.match.optionalQuantifier && !u.match.optionalQuantifier) && (a = c, r = u)
                }
                return r
            }

            function F(e, t, n) {
                return E().validPositions[e] || j(e, R(e, t ? t.slice() : t, n))
            }
                        ...
                        function v(t, n, a) {
                            ...
                            if ((E().tests[t] || E().validPositions[t]) && e.each(E().tests[t] || [E().validPositions[t]], function(e, t) {
                                ...
                                var s = r.locator[r.alternation],
                                    l = r.mloc[n] || r.mloc[s] || r.locator;
                                return l.slice((a !== i ? a : r.alternation) + 1)
                            }
                            return a !== i ? v(t, n) : i
                        }
                            ...
                            if (o.isGroup && u !== o) {
                                ...
                                if (-1 === w || "string" == typeof w) {
                                    ...
                                    for (var N = !1, R = 0; R < _.length; R++) {
                                        M = parseInt(_[R]), m = [], a = "string" == typeof w && v(c, M, C) || O.slice(), P.matches[M] && l(P.matches[M], [M].concat(s), u) ? o = !0 : 0 === R && (N = !0), x = m.slice(), c = D, m = [];
                                        for (var G = 0; G < x.length; G++) {
                                            ...
                                            for (var L = 0; L < S.length; L++) {
                                                ...
                                                if ("string" != typeof w || I.alternation !== i && -1 !== e.inArray(I.locator[I.alternation].toString(), _)) {
                                                    ...
                                                    if (q = H, Q = (z = I).locator.slice(z.alternation).join(""), W = q.locator.slice(q.alternation).join(""), Q == W && null === z.match.fn && null !== q.match.fn && q.match.fn.test(z.match.def, E(), t, !1, p, !1)) {
                                                        y(I, H) && (B = !0, S.splice(S.indexOf(H), 0, I));
                                                        break
                                                    }
                                                }
                                ...
                                for (var V = o, U = a.length > 0 ? a.shift() : 0; U < (isNaN(V.quantifier.max) ? U + 1 : V.quantifier.max) && c <= t; U++) {
                                    var K = n.matches[e.inArray(V, n.matches) - 1];
                                    if (o = l(K, [U].concat(s), K)) {
                                        if ((r = m[m.length - 1].match).optionalQuantifier = U > V.quantifier.min - 1, r.jit = U + K.matches.indexOf(r) >= V.quantifier.jit, f(r, K) && U > V.quantifier.min - 1) {
                                            d = !0, c = t;
                                            break
                                        }
            ...
            function G() {
                return E()._buffer === i && (E()._buffer = w(!1, 1), E().buffer === i && (E().buffer = E()._buffer.slice())), E()._buffer
            }

            function I(e) {
                return E().buffer !== i && !0 !== e || (E().buffer = w(!0, D(), !0)), E().buffer
            }
            ...
            function B(e, t, n) {
                ...
                for (r = e, a = e; a < t; a++)
                    if (M(!0), n[a] !== p.skipOptionalPartCharacter) {
                        var o = V(r, n[a], !0, !0);
            ...
            function H(t, n, a, r, o) {
                var s, l, u, c, p, f, m, d = e.extend(!0, {}, E().validPositions),
                    h = !1,
                    g = o !== i ? o : D();
                if (-1 === g && o === i) c = T(s = 0), l = c.alternation;
                else
                    for (; g >= 0; g--)
                    ...
                    m = parseInt(s), E().excludes[m] = E().excludes[m] || [], !0 !== t && E().excludes[m].push(O(c));
                    var v = [],
                        k = 0;
                    for (p = m; p < D(i, !0) + 1; p++)(f = E().validPositions[p]) && !0 !== f.generatedInput ? v.push(f.input) : p < t && k++, delete E().validPositions[p];
                    for (; E().excludes[m] && E().excludes[m].length < 10;) {
                        var y = -1 * k,
                            b = v.slice();
                        for (E().tests[m] = i, M(!0), h = !0; b.length > 0;) {
                            var x = b.shift();
                            if (!(h = V(D(i, !0) + 1, x, !1, r, !0))) break
                        }
                        if (h && n !== i) {
                            var P = D(t) + 1;
                            for (p = m; p < D() + 1; p++)((f = E().validPositions[p]) === i || null == f.match.fn) && p < t + y && y++;
                            h = V((t += y) > P ? P : t, n, a, r, !0)
                        }
                        if (h) break;
                        if (M(), c = T(m), E().validPositions = e.extend(!0, {}, d), !E().excludes[m]) {
                            h = H(t, n, a, r, m - 1);
                            break
                        }
                        var S = O(c);
                        ...
                        for (E().excludes[m].push(S), p = m; p < D(i, !0) + 1; p++) delete E().validPositions[p]
                    }
                }
            ...
            function V(t, n, a, r, o, s) {
                ...
                function f(n, a, o) {
                    ...
                    return e.each(R(n), function(c, f) {
                        var m = f.match;
                        if (I(!0), !1 !== (s = null != m.fn ? m.fn.test(a, E(), n, o, p, l(t)) : (a === m.def || a === p.skipOptionalPartCharacter) && "" !== m.def && {
                                c: $(n, m, !0) || m.def,
                                pos: n
                            })) {
                            var d = s.c !== i ? s.c : a,
                ...
                if (e.isFunction(p.preValidation) && !a && !0 !== r && !0 !== s && (m = p.preValidation(I(), c, n, l(t), p, E())), !0 === m) {
                    if (U(i, c, !0), (g === i || c < g) && (m = f(c, n, a), (!a || !0 === r) && !1 === m && !0 !== s)) {
                        ...
                        if (!h || null !== h.match.fn || h.match.def !== n && n !== p.skipOptionalPartCharacter) {
                            if ((p.insertMode || E().validPositions[q(c)] === i) && !z(c, !0))
                    ...
                    }!1 !== m || !1 === p.keepStatic || null != p.regex && !ae(I()) || a || !0 === o || (m = H(c, n, a, r)), !0 === m && (m = {
                        pos: c
                    })
                }
                ...
                return m && m.pos === i && (m.pos = c), !1 !== m && !0 !== s || (M(!0), E().validPositions = e.extend(!0, {}, d)), m
            }
            ...
            function U(t, n, a) {
                ...
                for (var o = t; o < n; o++)
                    if (E().validPositions[o] === i && !z(o, !0)) {
                        var s = 0 == o ? T(o) : E().validPositions[o - 1];
                        if (s) {
                            var l = R(o).slice();
                            ...
                            if ((u = e.extend({}, u, {
                                ...
                                E().validPositions[n] = i, r = V(n, c, !0, !0)
                            }
                        }
                    }
                return r
                ...
                if (t.begin > t.end && (s = t.end, l = t.begin), r = r !== i ? r : s, s !== l || p.insertMode && E().validPositions[r] !== i && a === i) {
                    ...
                    for (n && (E().validPositions[r] = e.extend(!0, {}, n), h++, m++, s < l && g++); g <= c; g++) {
                        ...
                        if (v !== i && (g >= l || g >= s && !0 !== v.generatedInput && o(g, u, {
                            ...
                            for (;
                                "" !== T(h).match.def;) {
                                if (!1 === d && u[h] && u[h].match.nativeDef === v.match.nativeDef) E().validPositions[h] = e.extend(!0, {}, u[h]), E().validPositions[h].input = v.input, U(i, h, !0), m = h + 1, f = !0;
                    ...
                    if (!f) return E().validPositions = e.extend(!0, {}, u), M(!0), !1
            ...
            function q(e, t) {
                for (var n = e + 1;
                    "" !== T(n).match.def && (!0 === t && (!0 !== T(n).match.newBlockMarker || !z(n)) || !0 !== t && !z(n));) n++;
                return n
            }
            ...
            function Q(e, t) {
                var n, i = e;
                if (i <= 0) return 0;
                for (; --i > 0 && (!0 === t && !0 !== T(i).match.newBlockMarker || !0 !== t && !z(i) && ((n = R(i)).length < 2 || 2 === n.length && "" === n[1].match.def)););
                return i
            }
            ...
            function W(t, n, a, r, o) {
                ...
                if (t !== i && (t.inputmask._valueSet(n.join("")), a === i || r !== i && "blur" === r.type ? se(t, a, 0 === n.length) : te(t, a), !0 === o)) {
                    ...
                    P = !0, u.trigger("input"), setTimeout(function() {
                        c === G().join("") ? u.trigger("cleared") : !0 === ae(n) && u.trigger("complete")
                    }, 0)
                }
            }
                ...
                Y = {
                    keydownEvent: function(t) {
                        var n = this,
                            ...
                            a = t.keyCode,
                            r = te(n);
                        if (a === u.keyCode.BACKSPACE || a === u.keyCode.DELETE || l && a === u.keyCode.BACKSPACE_SAFARI || t.ctrlKey && a === u.keyCode.X && !f("cut")) t.preventDefault(), re(0, a, r), W(n, I(!0), E().p, t, n.inputmask._valueGet() !== I().join(""));
                        else if (a === u.keyCode.END || a === u.keyCode.PAGE_DOWN) {
                            t.preventDefault();
                            var o = q(D());
                            te(n, t.shiftKey ? r.begin : o, o, !0)
                        ...
                        p.onKeyDown.call(this, t, I(), te(n).begin, p), S = -1 !== e.inArray(a, p.ignorables)
                    },
                    keypressEvent: function(t, n, a, r, o) {
                        ...
                        if (c) {
                            ...
                            E().writeOutBuffer = !0;
                            var k = V(m, h, r);
                            if (!1 !== k && (M(!0), f = k.caret !== i ? k.caret : q(k.pos.begin ? k.pos.begin : k.pos), E().p = f), f = (p.numericInput && k.caret === i ? Q(f) : f) + g, !1 !== a && (setTimeout(function() {
                    ...
                    pasteEvent: function(n) {
                        ...
                        if (l === (b ? G().reverse() : G()).slice(0, s.begin).join("") && (l = ""), u === (b ? G().reverse() : G()).slice(s.end).join("") && (u = ""), t.clipboardData && t.clipboardData.getData) o = l + t.clipboardData.getData("Text") + u;
                        else {
                        ...
                        return X(a, !1, !1, c.toString().split("")), W(a, I(), q(D()), n, d !== I().join("")), n.preventDefault()
                    },
                    inputFallBackEvent: function(t) {
                        ...
                        if (I().join("") !== r) {
                            ...
                            if (r = function(e, t, n) {
                                    ...
                                    return t
                                }(0, (i = o, "." === (n = r).charAt(i.begin - 1) && "" !== p.radixPoint && ((n = n.split(""))[i.begin - 1] = p.radixPoint.charAt(0), n = n.join("")), r = n), o), I().join("") !== r) {
                                var l = I().join(""),
                                    c = !p.numericInput && r.length > l.length ? -1 : 0,
                                    f = r.substr(0, o.begin),
                                    m = r.substr(o.begin),
                                    d = l.substr(0, o.begin + c),
                                    h = l.substr(o.begin + c),
                                    g = o,
                                    v = "",
                                    k = !1;
                                if (f !== d) {
                                    var y, b = (k = f.length >= d.length) ? f.length : d.length;
                                    for (y = 0; f.charAt(y) === d.charAt(y) && y < b; y++);
                                    k && (g.begin = y - c, v += f.slice(y, g.end))
                                }
                        ...
                        if (t.cancelable) {
                            ...
                            switch (t.inputType) {
                                ...
                                case "deleteContentBackward":
                                    ...
                                    return i.keyCode = u.keyCode.BACKSPACE, Y.keydownEvent.call(n, i), t.preventDefault();
                                case "deleteContentForward":
                                    var i = new e.Event("keydown");
                                    return i.keyCode = u.keyCode.DELETE, Y.keydownEvent.call(n, i), t.preventDefault()
                            }
                        }
                    },
                    setValueEvent: function(t) {
                        ...
                        e.isFunction(p.onBeforeMask) && (n = p.onBeforeMask.call(k, n, p) || n), X(this, !0, !1, n = n.split("")), d = I().join(""), (p.clearMaskOnLostFocus || p.clearIncomplete) && this.inputmask._valueGet() === G().join("") && this.inputmask._valueSet("")
                    },
                    focusEvent: function(e) {
                        var t = this,
                            n = t.inputmask._valueGet();
                        p.showMaskOnFocus && (!p.showMaskOnHover || p.showMaskOnHover && "" === n) && (t.inputmask._valueGet() !== I().join("") ? W(t, I(), q(D())) : !1 === A && te(t, q(D()))), !0 === p.positionCaretOnTab && !1 === A && Y.clickEvent.apply(t, [e, !0]), d = I().join("")
                    },
                                ...
                                if (a && (b ? t.end = t.begin : t.begin = t.end), t.begin === t.end) switch (p.positionCaretOnClick) {
                                    ...
                                    default:
                                        var s = t.begin,
                                            l = D(s, !0),
                                            u = q(l);
                                        if (s < u) te(r, z(s, !0) || z(s - 1, !0) ? s : q(s));
                                        else {
                    ...
                    cutEvent: function(i) {
                        ...
                        o.setData("text", b ? s.reverse().join("") : s.join("")), n.execCommand && n.execCommand("copy"), re(0, u.keyCode.DELETE, a), W(this, I(), E().p, i, d !== I().join(""))
                    },
                    blurEvent: function(t) {
                        ...
                        if (this.inputmask) {
                            ...
                            var a = this.inputmask._valueGet(),
                                r = I().slice();
                            "" === a && v === i || (p.clearMaskOnLostFocus && (-1 === D() && a === G().join("") ? r = [] : ie(r)), !1 === ae(r) && (setTimeout(function() {
                                n.trigger("incomplete")
                            }, 0), p.clearIncomplete && (M(), r = p.clearMaskOnLostFocus ? [] : G().slice())), W(this, r, i, t)), d !== I().join("") && (d = r.join(""), n.trigger("change"))
                        }
                    },
                    mouseenterEvent: function(e) {
                        A = !0, n.activeElement !== this && p.showMaskOnHover && (this.placeholder = (b ? I().slice().reverse() : I()).join(""))
                    },
                    submitEvent: function(e) {
                        d !== I().join("") && h.trigger("change"), p.clearMaskOnLostFocus && -1 === D() && y.inputmask._valueGet && y.inputmask._valueGet() === G().join("") && y.inputmask._valueSet(""), p.clearIncomplete && !1 === ae(I()) && y.inputmask._valueSet(""), p.removeMaskOnSubmit && (y.inputmask._valueSet(y.inputmask.unmaskedvalue(), !0), setTimeout(function() {
                            W(y, I())
                        }, 0))
                    },
            ...
            function X(t, n, a, r, o) {
                var s = this || t.inputmask,
                    ...
                    f = -1,
                    m = i;
                if (M(), a || !0 === p.autoUnmask) f = q(f);
                else {
                    var d = G().slice(0, q(-1)).join(""),
                        h = l.join("").match(new RegExp("^" + u.escapeRegex(d), "g"));
                    h && h.length > 0 && (l.splice(0, h.length * d.length), f = q(f))
                } - 1 === f ? (E().p = q(f), f = 0) : E().p = f, s.caretPos = {
                    begin: f
                }, e.each(l, function(n, r) {
                    if (r !== i)
                        if (E().validPositions[n] === i && l[n] === $(n) && z(n, !0) && !1 === V(n, l[n], !0, i, i, !0)) E().p++;
                        else {
                            var o = new e.Event("_checkval");
                            o.which = r.charCodeAt(0), c += r;
                            var u = D(i, !0);
                            p = f, d = c, -1 === w(!0, 0, !1).slice(p, q(p)).join("").replace(/'/g, "").indexOf(d) || z(p) || !(T(p).match.nativeDef === d.charAt(0) || null === T(p).match.fn && T(p).match.nativeDef === "'" + d.charAt(0) || " " === T(p).match.nativeDef && (T(p + 1).match.nativeDef === d.charAt(0) || null === T(p + 1).match.fn && T(p + 1).match.nativeDef === "'" + d.charAt(0))) ? (m = Y.keypressEvent.call(t, o, !0, !1, a, s.caretPos.begin)) && (f = s.caretPos.begin + 1, c = "") : m = Y.keypressEvent.call(t, o, !0, !1, a, u + 1), m && (W(i, I(), m.forwardPosition, o, !1), s.caretPos = {
            ...
            function te(a, r, o, s) {
                ...
                var u;
                if (r === i) return "selectionStart" in a ? (r = a.selectionStart, o = a.selectionEnd) : t.getSelection ? (u = t.getSelection().getRangeAt(0)).commonAncestorContainer.parentNode !== a && u.commonAncestorContainer !== a || (r = u.startOffset, o = u.endOffset) : n.selection && n.selection.createRange && (u = n.selection.createRange(), r = 0 - u.duplicate().moveStart("character", -a.inputmask._valueGet().length), o = r + u.text.length), {
                    begin: s ? r : l(r),
                    end: s ? o : l(o)
                };
                if (e.isArray(r) && (o = b ? r[0] : r[1], r = b ? r[1] : r[0]), r.begin !== i && (o = b ? r.begin : r.end, r = b ? r.end : r.begin), "number" == typeof r) {
                    ...
                    if (a.scrollLeft = c > a.scrollWidth ? c : 0, a.inputmask.caretPos = {
                        ...
                        }, "selectionStart" in a) a.selectionStart = r, a.selectionEnd = o;
            ...
            function ne(t) {
                ...
                for (n = s + 1; n < r.length; n++) a = F(n, c, n - 1), c = a.locator.slice(), l[n] = e.extend(!0, {}, a);
                var p = u && u.alternation !== i ? u.locator[u.alternation] : i;
                for (n = o - 1; n > s && ((a = l[n]).match.optionality || a.match.optionalQuantifier && a.match.newBlockMarker || p && (p !== l[n].locator[u.alternation] && null != a.match.fn || null === a.match.fn && a.locator[u.alternation] && L(a.locator[u.alternation].toString().split(","), p.toString().split(",")) && "" !== R(n)[0].def)) && r[n] === $(n, a.match); n--) o--;
                return t ? {
                    l: o,
                    def: l[o] ? l[o].match : i
                } : o
            ...
            function ae(t) {
                ...
                if (a.def === i || a.def.newBlockMarker || a.def.optionality || a.def.optionalQuantifier) {
                    ...
                    for (var o = 0; o <= r; o++) {
                        var s = F(o).match;
                        if (null !== s.fn && E().validPositions[o] === i && !0 !== s.optionality && !0 !== s.optionalQuantifier || null === s.fn && t[o] !== $(o, s)) {
                            n = !1;
                            break
                        }
                    }
            ...
            function re(e, t, n, a, r) {
                ...
                if (t === u.keyCode.BACKSPACE && n.end - n.begin < 1 ? (n.begin = Q(n.begin), E().validPositions[n.begin] !== i && E().validPositions[n.begin].input === p.groupSeparator && n.begin--) : t === u.keyCode.DELETE && n.begin === n.end && (n.end = z(n.end, !0) && E().validPositions[n.end] && E().validPositions[n.end].input !== p.radixPoint ? n.end + 1 : q(n.end) + 1, E().validPositions[n.begin] !== i && E().validPositions[n.begin].input === p.groupSeparator && n.end++), K(n), !0 !== a && !1 !== p.keepStatic || null !== p.regex) {
                    var s = H(!0);
                    if (s) {
                ...
                var c = D(n.begin, !0);
                if (c < n.begin || -1 === n.begin) E().p = q(c);
                    ...
                    return te(i, function(e) {
                        ...
                        for (t = 0, s = l.length; t <= s; t++) {
                            if (r.innerHTML += l.charAt(t) || "_", r.offsetWidth >= e) {
                                var c = e - u,
                                    p = r.offsetWidth - e;
                                r.innerHTML = l.charAt(t), c -= r.offsetWidth / 3, t = c < p ? t - 1 : t;
                                break
                            }
                            u = r.offsetWidth
                        }
            ...
            function se(e, t, a) {
                ...
                if (v !== i) {
                    ...
                    if (t === i ? t = te(e) : t.begin === i && (t = {
                        ...
                        var d = D();
                        do {
                            E().validPositions[c] ? (o = E().validPositions[c], r = o.match, s = o.locator.slice(), f(m[c])) : (o = F(c, s, c - 1), r = o.match, s = o.locator.slice(), !1 === p.jitMasking || c < d || "number" == typeof p.jitMasking && isFinite(p.jitMasking) && p.jitMasking > c ? f($(c, r)) : u = !1), c++
            ...
            if (u.prototype.positionColorMask = function(e, t) {
                ...
                case "isComplete":
                    return y = a.el, ae(I());
                case "unmaskedvalue":
                    return y !== i && a.value === i || (Z = a.value, Z = (e.isFunction(p.onBeforeMask) && p.onBeforeMask.call(k, Z, p) || Z).split(""), X.call(this, i, !1, !1, Z), e.isFunction(p.onBeforeWrite) && p.onBeforeWrite.call(k, i, I(), 0, p)), ee(y);
                case "mask":
                    ! function(t) {
                        J.off(t);
                        var a = function(t, a) {
                            ...
                            return !1 !== s ? function(t) {
                                ...
                                function u() {
                                    return this.inputmask ? this.inputmask.opts.autoUnmask ? this.inputmask.unmaskedvalue() : -1 !== D() || !0 !== a.nullable ? n.activeElement === this && a.clearMaskOnLostFocus ? (b ? ie(I().slice()).reverse() : ie(I().slice())).join("") : r.call(this) : "" : r.call(this)
                                }
                                ...
                                if (!t.inputmask.__valueGet) {
                                    if (!0 !== a.noValuePatching) {
                                        ...
                                        } else n.__lookupGetter__ && t.__lookupGetter__("value") && (r = t.__lookupGetter__("value"), s = t.__lookupSetter__("value"), t.__defineGetter__("value", u), t.__defineSetter__("value", c));
                                    ...
                                    t.inputmask._valueGet = function(e) {
                                        ...
                                        i !== I().join("") && n.trigger("setvalue")
                                    }))
                                }
                            }(t) : t.inputmask = i, s
                        }(t, p);
                        if (!1 !== a && (h = e(y = t), C = y.placeholder, -1 === (g = y !== i ? y.maxLength : i) && (g = i), !0 === p.colorMask && oe(y), r && ("inputmode" in y && (y.inputmode = p.inputmode, y.setAttribute("inputmode", p.inputmode)), !0 === p.disablePredictiveText && ("autocorrect" in y ? y.autocorrect = !1 : (!0 !== p.colorMask && oe(y), y.type = "password"))), !0 === a && (y.setAttribute("im-insert", p.insertMode), J.on(y, "submit", Y.submitEvent), J.on(y, "reset", Y.resetEvent), J.on(y, "blur", Y.blurEvent), J.on(y, "focus", Y.focusEvent), !0 !== p.colorMask && (J.on(y, "click", Y.clickEvent), J.on(y, "mouseleave", Y.mouseleaveEvent), J.on(y, "mouseenter", Y.mouseenterEvent)), J.on(y, "paste", Y.pasteEvent), J.on(y, "cut", Y.cutEvent), J.on(y, "complete", p.oncomplete), J.on(y, "incomplete", p.onincomplete), J.on(y, "cleared", p.oncleared), r || !0 === p.inputEventOnly ? y.removeAttribute("maxLength") : (J.on(y, "keydown", Y.keydownEvent), J.on(y, "keypress", Y.keypressEvent)), J.on(y, "input", Y.inputFallBackEvent), J.on(y, "beforeinput", Y.beforeInputEvent)), J.on(y, "setvalue", Y.setValueEvent), d = G().join(""), "" !== y.inputmask._valueGet(!0) || !1 === p.clearMaskOnLostFocus || n.activeElement === y)) {
                            var s = e.isFunction(p.onBeforeMask) && p.onBeforeMask.call(k, y.inputmask._valueGet(!0), p) || y.inputmask._valueGet(!0);
                            "" !== s && X(y, !0, !1, s.split(""));
                            var l = I().slice();
                            d = l.join(""), !1 === ae(l) && p.clearIncomplete && M(), p.clearMaskOnLostFocus && n.activeElement !== y && (-1 === D() ? l = [] : ie(l)), (!1 === p.clearMaskOnLostFocus || p.showMaskOnFocus && n.activeElement === y || "" !== y.inputmask._valueGet(!0)) && W(y, l), n.activeElement === y && te(y, q(D()))
                        }
                    }(y);
                    break;
                case "format":
                    return Z = (e.isFunction(p.onBeforeMask) && p.onBeforeMask.call(k, a.value, p) || a.value).split(""), X.call(this, i, !0, !1, Z), a.metadata ? {
                ...
                case "isValid":
                    ...
                    for (var le = I(), ue = ne(), ce = le.length - 1; ce > ue && !z(ce); ce--);
                    return le.splice(ue, ce + 1 - ue), ae(le) && a.value === I().join("");
                case "getemptymask":
                    return G().join("");
                case "remove":
                    return y && y.inputmask && (e.data(y, "_inputmask_opts", null), h = e(y), y.inputmask._valueSet(p.autoUnmask ? ee(y) : y.inputmask._valueGet(!0)), J.off(y), y.inputmask.colorMask && ((v = y.inputmask.colorMask).removeChild(y), v.parentNode.insertBefore(y, v), v.parentNode.removeChild(v)), Object.getOwnPropertyDescriptor && Object.getPrototypeOf ? Object.getOwnPropertyDescriptor(Object.getPrototypeOf(y), "value") && y.inputmask.__valueGet && Object.defineProperty(y, "value", {
                        get: y.inputmask.__valueGet,
                        set: y.inputmask.__valueSet,
                        configurable: !0
                    }) : n.__lookupGetter__ && y.__lookupGetter__("value") && y.inputmask.__valueGet && (y.__defineGetter__("value", y.inputmask.__valueGet), y.__defineSetter__("value", y.inputmask.__valueSet)), y.inputmask = i), y;
                case "getmetadata":
                    ...
                    if (d) b();
                        ...
                        case a.quantifiermarker[0]:
                            var S = new k(!1, !1, !0),
                                ...
                                C = A[0].split(","),
                                w = isNaN(C[0]) ? C[0] : parseInt(C[0]),
                                E = 1 === C.length ? w : isNaN(C[1]) ? C[1] : parseInt(C[1]);
                            "*" !== w && "+" !== w || (w = "*" === E ? 0 : 1), S.quantifier = {
                                min: w,
                                max: E,
                                jit: A[1]
                            };
    ...
    var i, a, r;
    "function" == typeof Symbol && Symbol.iterator;
    a = [n(2), n(4)], void 0 === (r = "function" == typeof(i = function(e, t, n) {
        function i(e, n) {
        ...
        return t.extendAliases({
            numeric: {
                ...
                postValidation: function(i, a, r) {
                    ...
                    var v = {
                        caret: c !== n && a.pos === n || l === n ? l : l + (r.numericInput ? -1 : 1),
                        buffer: p,
